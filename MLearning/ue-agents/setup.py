...
from ueagents.plugins import ML_AGENTS_STATS_WRITER, ML_AGENTS_TRAINER_TYPE
import ueagents.trainers

VERSION = ueagents.trainers.__version__
EXPECTED_TAG = ueagents.trainers.__release_tag__
