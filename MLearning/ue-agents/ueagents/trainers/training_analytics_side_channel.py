...
from ueagents.trainers.settings import RewardSignalType
from ueagents_envs.exception import UnrealCommunicationException
from ueagents_envs.side_channel import (
    IncomingMessage,
    OutgoingMessage,
    DefaultTrainingAnalyticsSideChannel,
)
from ueagents_envs.communicator_objects.training_analytics_pb2 import (
    TrainingEnvironmentInitialized,
    TrainingBehaviorInitialized,
)
from google.protobuf.any_pb2 import Any

from ueagents.trainers.settings import TrainerSettings, RunOptions
...
class TrainingAnalyticsSideChannel(DefaultTrainingAnalyticsSideChannel):
    ...
    def on_message_received(self, msg: IncomingMessage) -> None:
        raise UnrealCommunicationException(
    ...
    def environment_initialized(self, run_options: RunOptions) -> None:
        ...
        msg = TrainingEnvironmentInitialized(
            ...
            mlagents_version=ueagents.trainers.__version__,
            ueagents_envs_version=ueagents_envs.__version__,
