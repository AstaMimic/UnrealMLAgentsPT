...
from ueagents.trainers.env_manager import EnvManager, EnvironmentStep
...
from ueagents.trainers.agent_processor import AgentManager
from ueagents import torch_utils
from ueagents.torch_utils.globals import get_rank
    ...
    def start_learning(self, env_manager: EnvManager) -> None:
        ...
        try:
            ...
            if isinstance(ex, KeyboardInterrupt) or isinstance(
                ex, UnrealCommunicatorStoppedException
            ):
                pass
            else:
