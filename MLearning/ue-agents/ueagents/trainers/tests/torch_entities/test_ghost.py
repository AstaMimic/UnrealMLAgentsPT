...
from ueagents.trainers.ghost.trainer import GhostTrainer
from ueagents.trainers.ghost.controller import GhostController
...
from ueagents.trainers.settings import TrainerSettings, SelfPlaySettings
