...
from ueagents.trainers.demo_loader import write_demo
...
from ueagents_envs.communicator_objects.demonstration_meta_pb2 import (
    DemonstrationMetaProto,
)
from ueagents_envs.communicator_objects.brain_parameters_pb2 import (
