...
from ueagents.trainers.subprocess_env_manager import (
    SubprocessEnvManager,
    EnvironmentResponse,
    StepResponse,
    EnvironmentCommand,
)
from ueagents.trainers.env_manager import EnvironmentStep
...
from ueagents.trainers.tests.simple_test_envs import (
    SimpleEnvironment,
...
from ueagents.trainers.tests.check_env_trains import (
    check_environment_trains,
    DebugWriter,
)
from ueagents.trainers.tests.dummy_config import ppo_dummy_config
    ...
    def test_crashed_env_restarts(self, mock_create_worker):
        ...
        manager.step_queue.get_nowait.side_effect = [
            EnvironmentResponse(
                ...
                0,
                UnrealCommunicationException("Test msg"),
            ),
...
def test_subprocess_env_raises_errors(num_envs):
    ...
    with pytest.raises(UnrealEnvironmentException):
        env_manager.reset()
    env_manager.close()
