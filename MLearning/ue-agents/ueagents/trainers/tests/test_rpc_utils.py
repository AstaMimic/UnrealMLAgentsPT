...
from ueagents_envs.communicator_objects.observation_pb2 import (
    ObservationProto,
    NONE,
    PNG,
)
...
from ueagents_envs.exception import UnityObservationException
from ueagents_envs.rpc_utils import (
