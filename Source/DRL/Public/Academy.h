...
/**
 * @class UAcademy
 * @brief The core class managing the simulation environment in the DRL system.
 *
 ...
 */
UCLASS()
class DRL_API UAcademy : public UObject, public FTickableGameObject
{
	GENERATED_BODY()
...
public:
	...
	/// Current episode count within the DRL simulation.
	int32 EpisodeCount;
