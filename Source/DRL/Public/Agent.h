...
public:
	/**
	 * @brief Specifies the built-in actuator type specific to agents in DRL.
...
/**
 * @class UAgent
 * @brief Represents an agent in the DRL environment that interacts with its surroundings by observing,
